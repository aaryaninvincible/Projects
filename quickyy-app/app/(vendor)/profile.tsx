  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.header}>
        <Text style={[typography.h2, styles.title]}>Vendor Profile</Text>
      </View>
...
const styles = StyleSheet.create({
  ...
  shopCard: { backgroundColor: colors.surface, padding: 32, borderRadius: 20, alignItems: 'center', width: '100%', borderWidth: 1, borderColor: colors.border, marginBottom: 40 },
